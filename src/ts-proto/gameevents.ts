...
export const CMsgClearDecalsForSkeletonInstanceEvent = {
  ...
  create<I extends Exact<DeepPartial<CMsgClearDecalsForSkeletonInstanceEvent>, I>>(
    base?: I,
  ): CMsgClearDecalsForSkeletonInstanceEvent {
    return CMsgClearDecalsForSkeletonInstanceEvent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CMsgClearDecalsForSkeletonInstanceEvent>, I>>(
    object: I,
  ): CMsgClearDecalsForSkeletonInstanceEvent {
    const message = createBaseCMsgClearDecalsForSkeletonInstanceEvent();
    message.flagstoclear = object.flagstoclear ?? 0;
...
export const CMsgSource1LegacyGameEventList_keyT = {
  ...
  create<I extends Exact<DeepPartial<CMsgSource1LegacyGameEventList_keyT>, I>>(
    base?: I,
  ): CMsgSource1LegacyGameEventList_keyT {
    return CMsgSource1LegacyGameEventList_keyT.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CMsgSource1LegacyGameEventList_keyT>, I>>(
    object: I,
  ): CMsgSource1LegacyGameEventList_keyT {
    const message = createBaseCMsgSource1LegacyGameEventList_keyT();
...
export const CMsgSource1LegacyGameEventList_descriptorT = {
  ...
  create<I extends Exact<DeepPartial<CMsgSource1LegacyGameEventList_descriptorT>, I>>(
    base?: I,
  ): CMsgSource1LegacyGameEventList_descriptorT {
    return CMsgSource1LegacyGameEventList_descriptorT.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CMsgSource1LegacyGameEventList_descriptorT>, I>>(
    object: I,
  ): CMsgSource1LegacyGameEventList_descriptorT {
    const message = createBaseCMsgSource1LegacyGameEventList_descriptorT();
...
export const CMsgSource1LegacyGameEvent_keyT = {
  ...
  create<I extends Exact<DeepPartial<CMsgSource1LegacyGameEvent_keyT>, I>>(base?: I): CMsgSource1LegacyGameEvent_keyT {
    return CMsgSource1LegacyGameEvent_keyT.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CMsgSource1LegacyGameEvent_keyT>, I>>(
    object: I,
  ): CMsgSource1LegacyGameEvent_keyT {
    const message = createBaseCMsgSource1LegacyGameEvent_keyT();
    message.type = object.type ?? 0;
...
export const CMsgSosStartSoundEvent = {
  ...
  fromJSON(object: any): CMsgSosStartSoundEvent {
    return {
      ...
      packedParams: isSet(object.packedParams) ? bytesFromBase64(object.packedParams) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSosStartSoundEvent>, I>>(object: I): CMsgSosStartSoundEvent {
    ...
    message.packedParams = object.packedParams ?? new Uint8Array(0);
...
export const CMsgSosSetLibraryStackFields = {
  ...
  fromJSON(object: any): CMsgSosSetLibraryStackFields {
    return {
      ...
      packedFields: isSet(object.packedFields) ? bytesFromBase64(object.packedFields) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSosSetLibraryStackFields>, I>>(object: I): CMsgSosSetLibraryStackFields {
    ...
    message.packedFields = object.packedFields ?? new Uint8Array(0);
    return message;
  },
};
