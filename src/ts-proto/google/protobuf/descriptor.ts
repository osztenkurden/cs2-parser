...
export const ExtensionRangeOptions_Declaration: MessageFns<ExtensionRangeOptions_Declaration> = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExtensionRangeOptions_Declaration>, I>>(
    ...
    message.repeated = object.repeated ?? undefined;
    return message;
  },
};
...
export const FieldOptions_FeatureSupport: MessageFns<FieldOptions_FeatureSupport> = {
  encode(message: FieldOptions_FeatureSupport, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.removal_error !== undefined) {
      writer.uint32(42).string(message.removal_error);
    }
    return writer;
  },
  ...
  fromJSON(object: any): FieldOptions_FeatureSupport {
    return {
      ...
      edition_removed: isSet(object.editionRemoved)
        ...
        : undefined,
      removal_error: isSet(object.removalError)
  ...
  toJSON(message: FieldOptions_FeatureSupport): unknown {
    ...
    if (message.removal_error !== undefined) {
      obj.removalError = message.removal_error;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FieldOptions_FeatureSupport>, I>>(object: I): FieldOptions_FeatureSupport {
    const message = createBaseFieldOptions_FeatureSupport();
    message.edition_introduced = object.edition_introduced ?? undefined;
    message.edition_deprecated = object.edition_deprecated ?? undefined;
    message.deprecation_warning = object.deprecation_warning ?? undefined;
    message.edition_removed = object.edition_removed ?? undefined;
    message.removal_error = object.removal_error ?? undefined;
    return message;
  },
};
...
export const UninterpretedOption: MessageFns<UninterpretedOption> = {
  ...
  toJSON(message: UninterpretedOption): unknown {
    ...
    if (message.positive_int_value !== undefined) {
      obj.positiveIntValue = message.positive_int_value;
    }
    if (message.negative_int_value !== undefined) {
      obj.negativeIntValue = message.negative_int_value;
    }
    if (message.double_value !== undefined) {
...
export const FeatureSet: MessageFns<FeatureSet> = {
  ...
  fromPartial<I extends Exact<DeepPartial<FeatureSet>, I>>(object: I): FeatureSet {
    const message = createBaseFeatureSet();
    message.field_presence = object.field_presence ?? undefined;
    message.enum_type = object.enum_type ?? undefined;
    message.repeated_field_encoding = object.repeated_field_encoding ?? undefined;
    message.utf8_validation = object.utf8_validation ?? undefined;
    message.message_encoding = object.message_encoding ?? undefined;
    message.json_format = object.json_format ?? undefined;
    message.enforce_naming_style = object.enforce_naming_style ?? undefined;
    message.default_symbol_visibility = object.default_symbol_visibility ?? undefined;
    return message;
  },
};
...
export const FeatureSetDefaults: MessageFns<FeatureSetDefaults> = {
  ...
  fromPartial<I extends Exact<DeepPartial<FeatureSetDefaults>, I>>(object: I): FeatureSetDefaults {
    ...
    message.minimum_edition = object.minimum_edition ?? undefined;
    message.maximum_edition = object.maximum_edition ?? undefined;
    return message;
  },
};
