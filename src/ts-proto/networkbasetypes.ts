...
export function signonStateTFromJSON(object: any): SignonStateT {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return SignonStateT.UNRECOGNIZED;
  }
}
...
export function signonStateTToJSON(object: SignonStateT): string {
  switch (object) {
    ...
    case SignonStateT.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function spawnGroupFlagsTFromJSON(object: any): SpawnGroupFlagsT {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return SpawnGroupFlagsT.UNRECOGNIZED;
  }
}
...
export function spawnGroupFlagsTToJSON(object: SpawnGroupFlagsT): string {
  switch (object) {
    ...
    case SpawnGroupFlagsT.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const CNETMsgDisconnectLegacy = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgDisconnectLegacy>, I>>(base?: I): CNETMsgDisconnectLegacy {
    return CNETMsgDisconnectLegacy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgDisconnectLegacy>, I>>(object: I): CNETMsgDisconnectLegacy {
    const message = createBaseCNETMsgDisconnectLegacy();
...
export const CSVCMsgListGameEvents = {
  ...
  create<I extends Exact<DeepPartial<CSVCMsgListGameEvents>, I>>(base?: I): CSVCMsgListGameEvents {
    return CSVCMsgListGameEvents.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CSVCMsgListGameEvents>, I>>(object: I): CSVCMsgListGameEvents {
    const message = createBaseCSVCMsgListGameEvents();
...
export const CSVCMsgListGameEvents_eventT = {
  ...
  create<I extends Exact<DeepPartial<CSVCMsgListGameEvents_eventT>, I>>(base?: I): CSVCMsgListGameEvents_eventT {
    return CSVCMsgListGameEvents_eventT.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CSVCMsgListGameEvents_eventT>, I>>(object: I): CSVCMsgListGameEvents_eventT {
    const message = createBaseCSVCMsgListGameEvents_eventT();
    message.tick = object.tick ?? 0;
...
export const CNETMsgSpawnGroupLoad = {
  ...
  fromJSON(object: any): CNETMsgSpawnGroupLoad {
    return {
      ...
      spawngroupmanifest: isSet(object.spawngroupmanifest)
        ? bytesFromBase64(object.spawngroupmanifest)
        : new Uint8Array(0),
  ...
  create<I extends Exact<DeepPartial<CNETMsgSpawnGroupLoad>, I>>(base?: I): CNETMsgSpawnGroupLoad {
    return CNETMsgSpawnGroupLoad.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgSpawnGroupLoad>, I>>(object: I): CNETMsgSpawnGroupLoad {
    const message = createBaseCNETMsgSpawnGroupLoad();
    ...
    message.worldOffsetAngle = (object.worldOffsetAngle !== undefined && object.worldOffsetAngle !== null)
      ...
      : undefined;
    message.spawngroupmanifest = object.spawngroupmanifest ?? new Uint8Array(0);
...
export const CNETMsgSpawnGroupManifestUpdate = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgSpawnGroupManifestUpdate>, I>>(base?: I): CNETMsgSpawnGroupManifestUpdate {
    return CNETMsgSpawnGroupManifestUpdate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgSpawnGroupManifestUpdate>, I>>(
    object: I,
...
export const CNETMsgSpawnGroupSetCreationTick = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgSpawnGroupSetCreationTick>, I>>(
    base?: I,
  ): CNETMsgSpawnGroupSetCreationTick {
    return CNETMsgSpawnGroupSetCreationTick.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgSpawnGroupSetCreationTick>, I>>(
    object: I,
  ): CNETMsgSpawnGroupSetCreationTick {
    const message = createBaseCNETMsgSpawnGroupSetCreationTick();
    message.spawngrouphandle = object.spawngrouphandle ?? 0;
...
export const CNETMsgSpawnGroupUnload = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgSpawnGroupUnload>, I>>(base?: I): CNETMsgSpawnGroupUnload {
    return CNETMsgSpawnGroupUnload.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgSpawnGroupUnload>, I>>(object: I): CNETMsgSpawnGroupUnload {
    const message = createBaseCNETMsgSpawnGroupUnload();
    message.spawngrouphandle = object.spawngrouphandle ?? 0;
    message.flags = object.flags ?? 0;
    message.tickcount = object.tickcount ?? 0;
...
export const CNETMsgSpawnGroupLoadCompleted = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgSpawnGroupLoadCompleted>, I>>(base?: I): CNETMsgSpawnGroupLoadCompleted {
    return CNETMsgSpawnGroupLoadCompleted.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgSpawnGroupLoadCompleted>, I>>(
    object: I,
...
export const CSVCMsgGameSessionConfiguration = {
  ...
  create<I extends Exact<DeepPartial<CSVCMsgGameSessionConfiguration>, I>>(base?: I): CSVCMsgGameSessionConfiguration {
    return CSVCMsgGameSessionConfiguration.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CSVCMsgGameSessionConfiguration>, I>>(
    object: I,
...
export const CNETMsgDebugOverlay = {
  ...
  create<I extends Exact<DeepPartial<CNETMsgDebugOverlay>, I>>(base?: I): CNETMsgDebugOverlay {
    return CNETMsgDebugOverlay.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CNETMsgDebugOverlay>, I>>(object: I): CNETMsgDebugOverlay {
    const message = createBaseCNETMsgDebugOverlay();
