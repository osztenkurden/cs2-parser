...
export function p2PMessagesFromJSON(object: any): P2PMessages {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return P2PMessages.UNRECOGNIZED;
  }
}
...
export function cP2PVoice_HandlerFlagsFromJSON(object: any): CP2PVoice_HandlerFlags {
  switch (object) {
    ...
    case "UNRECOGNIZED":
    default:
      return CP2PVoice_HandlerFlags.UNRECOGNIZED;
  }
}
...
export function cP2PVoice_HandlerFlagsToJSON(object: CP2PVoice_HandlerFlags): string {
  switch (object) {
    case CP2PVoice_HandlerFlags.Played_Audio:
      return "Played_Audio";
    case CP2PVoice_HandlerFlags.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const CP2PTextMessage = {
  ...
  fromJSON(object: any): CP2PTextMessage {
    return { text: isSet(object.text) ? bytesFromBase64(object.text) : new Uint8Array(0) };
  },
  ...
  create<I extends Exact<DeepPartial<CP2PTextMessage>, I>>(base?: I): CP2PTextMessage {
    return CP2PTextMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PTextMessage>, I>>(object: I): CP2PTextMessage {
    const message = createBaseCP2PTextMessage();
...
export const CSteamVoiceEncoding = {
  ...
  fromJSON(object: any): CSteamVoiceEncoding {
    return { voiceData: isSet(object.voiceData) ? bytesFromBase64(object.voiceData) : new Uint8Array(0) };
  },
  ...
  create<I extends Exact<DeepPartial<CSteamVoiceEncoding>, I>>(base?: I): CSteamVoiceEncoding {
    return CSteamVoiceEncoding.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CSteamVoiceEncoding>, I>>(object: I): CSteamVoiceEncoding {
    const message = createBaseCSteamVoiceEncoding();
...
export const CP2PVoice = {
  ...
  create<I extends Exact<DeepPartial<CP2PVoice>, I>>(base?: I): CP2PVoice {
    return CP2PVoice.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PVoice>, I>>(object: I): CP2PVoice {
    const message = createBaseCP2PVoice();
...
export const CP2PPing = {
  ...
  create<I extends Exact<DeepPartial<CP2PPing>, I>>(base?: I): CP2PPing {
    return CP2PPing.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PPing>, I>>(object: I): CP2PPing {
    const message = createBaseCP2PPing();
...
export const CP2PVRAvatarPosition = {
  ...
  create<I extends Exact<DeepPartial<CP2PVRAvatarPosition>, I>>(base?: I): CP2PVRAvatarPosition {
    return CP2PVRAvatarPosition.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PVRAvatarPosition>, I>>(object: I): CP2PVRAvatarPosition {
    const message = createBaseCP2PVRAvatarPosition();
...
export const CP2PVRAvatarPosition_COrientation = {
  ...
  create<I extends Exact<DeepPartial<CP2PVRAvatarPosition_COrientation>, I>>(
    base?: I,
  ): CP2PVRAvatarPosition_COrientation {
    return CP2PVRAvatarPosition_COrientation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PVRAvatarPosition_COrientation>, I>>(
    object: I,
  ): CP2PVRAvatarPosition_COrientation {
    const message = createBaseCP2PVRAvatarPosition_COrientation();
...
export const CP2PWatchSynchronization = {
  ...
  create<I extends Exact<DeepPartial<CP2PWatchSynchronization>, I>>(base?: I): CP2PWatchSynchronization {
    return CP2PWatchSynchronization.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CP2PWatchSynchronization>, I>>(object: I): CP2PWatchSynchronization {
    const message = createBaseCP2PWatchSynchronization();
