...
export interface CMsgSteamDatagramGameserverPingReplyData {
  ...
  routingBlob?: Uint8Array | undefined;
}
...
export interface CMsgSteamDatagramConnectionClosed {
  ...
  fromRelaySessionId?: number | undefined;
  forwardTargetRelayRoutingToken?: Uint8Array | undefined;
...
export interface CMsgSteamDatagramGameserverSessionEstablished {
  ...
  dummyLegacyIdentityBinary?: Uint8Array | undefined;
...
export interface CMsgSteamDatagramP2PSessionRequestBody {
  ...
  encryptedData?: Uint8Array | undefined;
  encryptionYourPublicKeyLeadByte?: number | undefined;
  encryptionMyEphemeralPublicKey?: Uint8Array | undefined;
  protocolVersion?: number | undefined;
  networkConfigVersion?: string | undefined;
  platform?: string | undefined;
  build?: string | undefined;
...
export interface CMsgSteamDatagramP2PSessionEstablished {
  connectionId?: number | undefined;
  secondsUntilShutdown?: number | undefined;
  relayRoutingToken?: Uint8Array | undefined;
  seqNumR2c?: number | undefined;
}
...
export interface CMsgSteamDatagramP2PBadRouteRouterToClient {
  connectionId?: number | undefined;
  failedRelayRoutingToken?: Uint8Array | undefined;
  ackForwardTargetRevision?: number | undefined;
  kludgePad?: string | undefined;
}
...
export interface CMsgSteamDatagramP2PRoutes_RelayCluster {
  ...
  sessionRelayRoutingToken?: Uint8Array | undefined;
}
...
export interface CMsgSteamDatagramSetSecondaryAddressRequest {
  ...
  kludgePad?: Uint8Array | undefined;
}
...
function createBaseCMsgSteamNetworkingIPAddress(): CMsgSteamNetworkingIPAddress {
  return { v4: 0, v6: new Uint8Array(0) };
}
...
export const CMsgSteamNetworkingIPAddress = {
  ...
  fromJSON(object: any): CMsgSteamNetworkingIPAddress {
    return {
      ...
      v6: isSet(object.v6) ? bytesFromBase64(object.v6) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamNetworkingIPAddress>, I>>(object: I): CMsgSteamNetworkingIPAddress {
    ...
    message.v6 = object.v6 ?? new Uint8Array(0);
    return message;
  },
};

function createBaseCMsgSteamDatagramSignedMessageGeneric(): CMsgSteamDatagramSignedMessageGeneric {
  return { cert: undefined, signedData: new Uint8Array(0), signature: new Uint8Array(0), dummyPad: new Uint8Array(0) };
}
...
export const CMsgSteamDatagramSignedMessageGeneric = {
  ...
  fromJSON(object: any): CMsgSteamDatagramSignedMessageGeneric {
    return {
      ...
      dummyPad: isSet(object.dummyPad) ? bytesFromBase64(object.dummyPad) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramSignedMessageGeneric>, I>>(
    ...
    message.dummyPad = object.dummyPad ?? new Uint8Array(0);
    return message;
  },
};
...
export const CMsgSteamDatagramGameserverPingRequestBody = {
  ...
  fromJSON(object: any): CMsgSteamDatagramGameserverPingRequestBody {
    return {
      ...
      myIps: globalThis.Array.isArray(object?.myIps)
        ...
        : [],
      echo: isSet(object.echo) ? bytesFromBase64(object.echo) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramGameserverPingRequestBody>, I>>(
    ...
    message.echo = object.echo ?? new Uint8Array(0);
    return message;
  },
};
...
export const CMsgSteamDatagramGameserverPingReplyData = {
  ...
  fromJSON(object: any): CMsgSteamDatagramGameserverPingReplyData {
    return {
      ...
      routingBlob: isSet(object.routingBlob) ? bytesFromBase64(object.routingBlob) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramGameserverPingReplyData>, I>>(
    ...
    message.routingBlob = object.routingBlob ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseCMsgSteamDatagramConnectionClosed(): CMsgSteamDatagramConnectionClosed {
  return {
    ...
    forwardTargetRelayRoutingToken: new Uint8Array(0),
...
export const CMsgSteamDatagramConnectionClosed = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramConnectionClosed>, I>>(
    ...
    message.fromRelaySessionId = object.fromRelaySessionId ?? 0;
    message.forwardTargetRelayRoutingToken = object.forwardTargetRelayRoutingToken ?? new Uint8Array(0);
...
function createBaseCMsgSteamDatagramGameserverSessionEstablished(): CMsgSteamDatagramGameserverSessionEstablished {
  return {
    ...
    secondsUntilShutdown: 0,
    seqNumR2c: 0,
    dummyLegacyIdentityBinary: new Uint8Array(0),
...
export const CMsgSteamDatagramGameserverSessionEstablished = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramGameserverSessionEstablished>, I>>(
    ...
    message.dummyLegacyIdentityBinary = object.dummyLegacyIdentityBinary ?? new Uint8Array(0);
...
function createBaseCMsgSteamDatagramP2PSessionRequestBody(): CMsgSteamDatagramP2PSessionRequestBody {
  return {
    ...
    encryptionMyEphemeralPublicKey: new Uint8Array(0),
    protocolVersion: 0,
    networkConfigVersion: "0",
    platform: "",
    build: "",
...
export const CMsgSteamDatagramP2PSessionRequestBody = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramP2PSessionRequestBody>, I>>(
    ...
    message.encryptionMyEphemeralPublicKey = object.encryptionMyEphemeralPublicKey ?? new Uint8Array(0);
    message.protocolVersion = object.protocolVersion ?? 0;
    message.networkConfigVersion = object.networkConfigVersion ?? "0";
    message.platform = object.platform ?? "";
    message.build = object.build ?? "";
...
function createBaseCMsgSteamDatagramP2PSessionRequest(): CMsgSteamDatagramP2PSessionRequest {
  return { cert: undefined, body: new Uint8Array(0), signature: new Uint8Array(0) };
}
...
function createBaseCMsgSteamDatagramP2PSessionEstablished(): CMsgSteamDatagramP2PSessionEstablished {
  return { connectionId: 0, secondsUntilShutdown: 0, relayRoutingToken: new Uint8Array(0), seqNumR2c: 0 };
}
...
export const CMsgSteamDatagramP2PSessionEstablished = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramP2PSessionEstablished>, I>>(
    ...
    message.connectionId = object.connectionId ?? 0;
    message.secondsUntilShutdown = object.secondsUntilShutdown ?? 0;
    message.relayRoutingToken = object.relayRoutingToken ?? new Uint8Array(0);
    message.seqNumR2c = object.seqNumR2c ?? 0;
    return message;
  },
};
...
export const CMsgSteamDatagramConnectionStatsP2PClientToRouter = {
  ...
  fromJSON(object: any): CMsgSteamDatagramConnectionStatsP2PClientToRouter {
    return {
      ...
      forwardTargetRelayRoutingToken: isSet(object.forwardTargetRelayRoutingToken)
        ...
        : new Uint8Array(0),
      forwardTargetRevision: isSet(object.forwardTargetRevision) ? globalThis.Number(object.forwardTargetRevision) : 0,
      routes: isSet(object.routes) ? bytesFromBase64(object.routes) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramConnectionStatsP2PClientToRouter>, I>>(
    ...
    message.forwardTargetRelayRoutingToken = object.forwardTargetRelayRoutingToken ?? new Uint8Array(0);
    message.forwardTargetRevision = object.forwardTargetRevision ?? 0;
    message.routes = object.routes ?? new Uint8Array(0);
...
function createBaseCMsgSteamDatagramP2PBadRouteRouterToClient(): CMsgSteamDatagramP2PBadRouteRouterToClient {
  return { connectionId: 0, failedRelayRoutingToken: new Uint8Array(0), ackForwardTargetRevision: 0, kludgePad: "0" };
}
...
export const CMsgSteamDatagramP2PBadRouteRouterToClient = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramP2PBadRouteRouterToClient>, I>>(
    ...
    const message = createBaseCMsgSteamDatagramP2PBadRouteRouterToClient();
    message.connectionId = object.connectionId ?? 0;
    message.failedRelayRoutingToken = object.failedRelayRoutingToken ?? new Uint8Array(0);
    message.ackForwardTargetRevision = object.ackForwardTargetRevision ?? 0;
    message.kludgePad = object.kludgePad ?? "0";
    return message;
  },
...
function createBaseCMsgSteamDatagramP2PRoutes_RelayCluster(): CMsgSteamDatagramP2PRoutes_RelayCluster {
  return { popId: 0, pingMs: 0, scorePenalty: 0, sessionRelayRoutingToken: new Uint8Array(0) };
}
...
export const CMsgSteamDatagramP2PRoutes_RelayCluster = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramP2PRoutes_RelayCluster>, I>>(
    ...
    message.sessionRelayRoutingToken = object.sessionRelayRoutingToken ?? new Uint8Array(0);
    return message;
  },
};
...
export const CMsgSteamDatagramSetSecondaryAddressRequest = {
  ...
  fromJSON(object: any): CMsgSteamDatagramSetSecondaryAddressRequest {
    return {
      ...
      requestSendDuplication: isSet(object.requestSendDuplication)
        ...
        : false,
      kludgePad: isSet(object.kludgePad) ? bytesFromBase64(object.kludgePad) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramSetSecondaryAddressRequest>, I>>(
    ...
    message.kludgePad = object.kludgePad ?? new Uint8Array(0);
    return message;
  },
};
