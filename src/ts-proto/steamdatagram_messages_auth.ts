...
export interface CMsgSteamDatagramRelayAuthTicket {
  ...
  gameserverAddress?: Uint8Array | undefined;
  ...
  legacyAuthorizedClientIdentityBinary?: Uint8Array | undefined;
  legacyGameserverIdentityBinary?: Uint8Array | undefined;
}
...
export interface CMsgSteamDatagramGameCoordinatorServerLogin {
  ...
  legacyIdentityBinary?: Uint8Array | undefined;
...
function createBaseCMsgSteamDatagramRelayAuthTicket(): CMsgSteamDatagramRelayAuthTicket {
  return {
    ...
    gameserverAddress: new Uint8Array(0),
    appId: 0,
    virtualPort: 0,
    extraFields: [],
    ...
    legacyAuthorizedClientIdentityBinary: new Uint8Array(0),
    legacyGameserverIdentityBinary: new Uint8Array(0),
  };
}
...
export const CMsgSteamDatagramRelayAuthTicket = {
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramRelayAuthTicket>, I>>(
    ...
    message.gameserverAddress = object.gameserverAddress ?? new Uint8Array(0);
    ...
    message.legacyAuthorizedClientIdentityBinary = object.legacyAuthorizedClientIdentityBinary ?? new Uint8Array(0);
    message.legacyGameserverIdentityBinary = object.legacyGameserverIdentityBinary ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseCMsgSteamDatagramSignedRelayAuthTicket(): CMsgSteamDatagramSignedRelayAuthTicket {
  return { reservedDoNotUse: "0", ticket: new Uint8Array(0), signature: new Uint8Array(0), keyId: "0", certs: [] };
}
...
function createBaseCMsgSteamDatagramCachedCredentialsForApp(): CMsgSteamDatagramCachedCredentialsForApp {
  return { privateKey: new Uint8Array(0), cert: new Uint8Array(0), relayTickets: [] };
}
...
function createBaseCMsgSteamDatagramGameCoordinatorServerLogin(): CMsgSteamDatagramGameCoordinatorServerLogin {
  return {
    timeGenerated: 0,
    appid: 0,
    routing: new Uint8Array(0),
    appdata: new Uint8Array(0),
    legacyIdentityBinary: new Uint8Array(0),
    identityString: "",
    dummySteamId: "0",
  };
}
...
export const CMsgSteamDatagramGameCoordinatorServerLogin = {
  ...
  fromJSON(object: any): CMsgSteamDatagramGameCoordinatorServerLogin {
    return {
      ...
      appid: isSet(object.appid) ? globalThis.Number(object.appid) : 0,
      routing: isSet(object.routing) ? bytesFromBase64(object.routing) : new Uint8Array(0),
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramGameCoordinatorServerLogin>, I>>(
    ...
    message.appid = object.appid ?? 0;
    message.routing = object.routing ?? new Uint8Array(0);
    message.appdata = object.appdata ?? new Uint8Array(0);
    message.legacyIdentityBinary = object.legacyIdentityBinary ?? new Uint8Array(0);
...
function createBaseCMsgSteamDatagramSignedGameCoordinatorServerLogin(): CMsgSteamDatagramSignedGameCoordinatorServerLogin {
  return { cert: undefined, login: new Uint8Array(0), signature: new Uint8Array(0) };
}
...
export const CMsgSteamDatagramSignedGameCoordinatorServerLogin = {
  ...
  fromJSON(object: any): CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    return {
      ...
      login: isSet(object.login) ? bytesFromBase64(object.login) : new Uint8Array(0),
      signature: isSet(object.signature) ? bytesFromBase64(object.signature) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CMsgSteamDatagramSignedGameCoordinatorServerLogin>, I>>(
    ...
    message.cert = (object.cert !== undefined && object.cert !== null)
      ...
      : undefined;
    message.login = object.login ?? new Uint8Array(0);
    message.signature = object.signature ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseCMsgSteamDatagramHostedServerAddressPlaintext(): CMsgSteamDatagramHostedServerAddressPlaintext {
  return { ipv4: 0, ipv6: new Uint8Array(0), port: 0, routingSecret: "0", protocolVersion: 0 };
}
